...
input string   InpAppUrl           = "http://localhost:3000"; // Web App Root URL (Add to MT5 Tools -> Options -> EA)
input string   InpApiToken         = "ict_secret_token";      // API Authentication Token
